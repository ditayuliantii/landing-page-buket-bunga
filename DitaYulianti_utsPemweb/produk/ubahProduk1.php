...
$produk1 = query("SELECT * FROM produk WHERE id_produk = $id")[0];
                ...
                <div class="card-body text-center">
                    <div class="p-3">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Ubah Produk Baru</h1>
                        </div>
                        ...
                        <form class="user" method="POST" action="" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="gambarLama" value="<?= $produk1["gambar"]; ?>">

                            <div class="form-group">
                                <input type="text" class="form-control control-user-control mt-2" name="nama"
                                    placeholder="Nama Produk" value="<?= $produk1["nama"]; ?>">
                            </div>

                            <div class=" form-group">
                                <input type="text" class="form-control control-user-control mt-3" name="rating"
                                    placeholder="Rating" value="<?= $produk1["rating"]; ?>">
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control control-user-control mt-3 my-3" name="harga"
                                    placeholder="Harga($)" value="<?= $produk1["harga"]; ?>">
                            </div>


                            <div class="form-group text-center">
                                <img src="../assets/img/<?= $produk1['gambar']; ?>" width="250px"> <br>
